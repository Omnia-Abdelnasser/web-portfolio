        ...
        >
          <div className="space-y-4">
            {data?.contentsTitle?.map((contentTitle, idx) => (
              <div
                key={contentTitle.id}
                className="border border-[#25c1dd] rounded-xl bg-white/5 overflow-hidden"
              >
                <button
                ...
                <AnimatePresence>
                  {openIndex === idx && (
                    <motion.div
                      ...
                      className="px-8 pb-4 pt-2 space-y-2"
                    >
                      {contentTitle.contents &&
                      contentTitle.contents.length > 0 ? (
                        contentTitle.contents.map((content) => (
                          <a
                            ...
                            className={`text-xl font-normal text-[#27b1b1] block px-4 py-2 rounded hover:text-[#25c1dd] transition font-medium ${
                              !isValidUrl(content.contentUrl)
