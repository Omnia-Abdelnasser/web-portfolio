import{d as x,j as r}from"./index-FzYD0WA6.js";import{u as p}from"./firestore-DA1wv-iM.js";import{m as f}from"./proxy-Tmr91tP3.js";import"./firebase-YnCF1Ofz.js";const g=()=>{const e=x.c(8),{isLoading:m,error:d,data:l}=p();if(m){let t;return e[0]===Symbol.for("react.memo_cache_sentinel")?(t=r.jsx("p",{className:` bg-secondary text-center text-2xl font-semibold\r
