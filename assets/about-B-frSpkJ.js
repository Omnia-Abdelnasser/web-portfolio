import{d as x,j as s}from"./index-BA_moiHS.js";import{u as p}from"./firestore-CJFz8pg1.js";import{m as f}from"./proxy-CLkIYrug.js";import"./firebase-YnCF1Ofz.js";const g=()=>{const e=x.c(8),{isLoading:m,error:d,data:l}=p();if(m){let t;return e[0]===Symbol.for("react.memo_cache_sentinel")?(t=s.jsx("p",{className:` bg-secondary text-center text-2xl font-semibold
